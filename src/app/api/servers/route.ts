  ...
  try {
    ...
    const server = await prisma.server.create({
      data: {
        ...
        vmDockerPollIntervalSec: Number(body.vmDockerPollIntervalSec ?? 7200),
        ...
        wireguardEnabled: Boolean(body.wireguardEnabled ?? false),
        storageEnabled: Boolean(body.storageEnabled ?? false),
        ...
        netUploadWarn: Number(body.netUploadWarn ?? 800),
        netUploadCrit: Number(body.netUploadCrit ?? 950),
        netDownloadWarn: Number(body.netDownloadWarn ?? 800),
        netDownloadCrit: Number(body.netDownloadCrit ?? 950),
