      ...
      {canControl && (
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="sm:max-w-sm">
            <DialogHeader>
              <DialogTitle>Image löschen?</DialogTitle>
              <DialogDescription>
                „{image.repository}:{image.tag}“ wird vom Server entfernt.
              </DialogDescription>
            </DialogHeader>
            <div className="flex items-center justify-between">
              <div>
                <Label htmlFor="force-remove">Erzwingen</Label>
                <p className="text-xs text-muted-foreground">
                  Auch löschen, wenn noch Container darauf basieren
                </p>
              </div>
